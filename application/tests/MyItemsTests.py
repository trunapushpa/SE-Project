...
class MyItemsTests(unittest.TestCase):
    ...
    def test_user_items_page(self):
        ...
        response = self.app.get('/myitems')
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'My Items', response.data)

    def test_user_items_without_logging_in(self):
        response = self.app.get('/myitems')
